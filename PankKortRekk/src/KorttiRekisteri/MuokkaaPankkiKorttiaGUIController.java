 ...
 *
 */
public class MuokkaaPankkiKorttiaGUIController implements ModalControllerInterface <String> {
    ...
    public static String alkuNaytto(Stage modalityStage, String oletus) {
        return ModalController.showModal(MuokkaJasenGUIController.class.getResource("MuokkaaPankkiKorttiaGUIView.fxml"), "Muokkaa pankkikorttia", modalityStage, oletus);
    }
}