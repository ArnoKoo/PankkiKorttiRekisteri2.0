 ...
 *
 */
public class LisaaHenkilonKorttiGUIController implements ModalControllerInterface <String> {
    ...
    public static String alkuNaytto(Stage modalityStage, String oletus) {
        return ModalController.showModal(MuokkaJasenGUIController.class.getResource("LisaaHenkilonKorttiGUIView.fxml"), "Lopeta", modalityStage, oletus);
    }
}